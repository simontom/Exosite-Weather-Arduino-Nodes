...
// Switches
////////////////////////////////
#warning "WATCHDOG MUST STAY FALSE UNTIL CORRECT (e.g. Optiboot) BOOTLOADER WITH WDT HANDLING ENABLED IS UPLOADED"
#define WATCHDOG_ENABLED	false	/* MUST STAY FALSE UNTIL CORRECT (e.g. Optiboot) BOOTLOADER WITH WDT HANDLING ENABLED IS UPLOADED */
...
#define DELAY_BETWEEN_DHT22_READINGS_MS	444
